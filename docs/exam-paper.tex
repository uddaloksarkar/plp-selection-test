...
\emph{Reported by a research scholar:} ``I cannot copy anything into
...
genuinely full, and the files you can see do not add up to the space reported
as used. \texttt{/srv/spool} refuses to create files \emph{although \texttt{df}
reports free space} --- something other than free bytes has run out.
